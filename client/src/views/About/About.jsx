        ...
        <div className={styles.divInfo}>
            ...
            <div className={styles.infoPanel}>
                ...
                <div className={styles.divP}>
                    <p className={styles.paragraph}>Hi, my name is Federico Gabriel Bastias Cano, beginner developer, currently studying in the bootcamp I'm Henry. I am a normal boy living in Tupungato Mendoza, province of Argentina, completely passionate about technology since I can remember. Characterized by a responsible and dedicated behavior, when I have something in mind, persevere to achieve it and make the most of it. My other passions are soccer (a River Plate fan) and good music, nothing in particular. </p>
